...
# ================= 配置区 =================
INPUT_FILE = "../data/processed/golden_samples_to_label.csv"
OUTPUT_FILE = "../data/processed/labeled_golden_samples.csv"
CHECKPOINT_FILE = "../data/processed/labeled_golden_samples_checkpoint.csv"
