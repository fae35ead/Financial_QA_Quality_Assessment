...
INPUT_FILE = PROJECT_ROOT / "data" / "processed" / "labeled_golden_samples.csv"
OUTPUT_DIR = PROJECT_ROOT / "models" / "teacher_cross_encoder"
# 使用本地已下载的中文 RoBERTa-wwm-ext 模型目录，避免从 HuggingFace 在线下载
MODEL_NAME = PROJECT_ROOT / "models" / "pretrained_models" / "chinese-roberta-wwm-ext"
...
def main():
    ...
    model_path = str(MODEL_NAME.resolve())
    ...
    training_args = TrainingArguments(
        ...
        logging_dir=str((PROJECT_ROOT / "logs").resolve()),
